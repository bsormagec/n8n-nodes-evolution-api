...
export const groupsFields: INodeProperties[] = [
	...
	},
	{
		...
		default: '',
		required: true,
		description: 'Enter the numbers of the participants separated by commas (e.g., 5511999999999,5511888888888)',
		displayOptions: {
			show: {
				resource: ['groups-api'],
				operation: ['create-group'],
	...
	},
	{
		...
		default: '',
		required: true,
		description: 'ID of the group that will have the image updated',
		displayOptions: {
			show: {
				resource: ['groups-api'],
				operation: ['update-group-picture'],
	...
	},
	{
		...
		default: '',
		required: true,
		description: 'ID of the group that will have the name updated',
		displayOptions: {
			show: {
				resource: ['groups-api'],
				operation: ['update-group-name'],
	...
	},
	{
		...
		default: '',
		required: true,
		description: 'ID of the group that will have the description updated',
		displayOptions: {
			show: {
				resource: ['groups-api'],
				operation: ['update-group-description'],
	...
	},
	{
		...
		required: true,
		description: 'Message to be sent along with the invite link',
		displayOptions: {
			show: {
				resource: ['groups-api'],
				operation: ['send-invite-link'],
	...
	},
	{
		...
		default: '',
		required: true,
		description: 'Enter the numbers of the recipients separated by commas (e.g., 5511999999999,5511888888888)',
		displayOptions: {
			show: {
				resource: ['groups-api'],
				operation: ['send-invite-link'],
	...
	},
	{
		...
		default: '',
		required: true,
		description: 'Invite code of the group (e.g., JZNHJLvnNd04UvGefiEZAA)',
		displayOptions: {
			show: {
				resource: ['groups-api'],
				operation: ['fetch-group-by-code'],
	...
	},
	{
		...
		default: 'inviteCode',
		required: true,
		description: 'Choose the method to fetch the groups',
		displayOptions: {
			show: {
				resource: ['groups-api'],
				operation: ['fetch-groups'],
	...
	},
	{
		...
		default: '',
		required: true,
		description: 'ID of the group to fetch the participants',
		displayOptions: {
			show: {
				resource: ['groups-api'],
				operation: ['find-participants'],
	...
	},
	{
		...
		default: '',
		required: true,
		description: 'ID of the group to update the members',
		displayOptions: {
			show: {
				resource: ['groups-api'],
				operation: ['update-participants'],
	...
	},
	{
		...
		default: '',
		required: true,
		description: 'ID of the group to update the settings',
		displayOptions: {
			show: {
				resource: ['groups-api'],
				operation: ['update-settings'],
	...
	},
	{
		...
		default: '',
		required: true,
		description: 'ID of the group to configure ephemeral messages',
		displayOptions: {
			show: {
				resource: ['groups-api'],
				operation: ['toggle-ephemeral'],
	...
	},
	{
		...
		default: 0,
		required: true,
		description: 'Expiration time of the messages',
		displayOptions: {
			show: {
				resource: ['groups-api'],
				operation: ['toggle-ephemeral'],
