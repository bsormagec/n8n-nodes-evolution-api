...
export const instancesFields: INodeProperties[] = [
	...
	{
		displayName: 'Apikey For Instance',
		name: 'token',
		type: 'string',
		typeOptions: {
			password: true,
				...
				options: [
					{
						...
						values: [
							...
							},
							{
								...
								default: 0,
								description:
									'Enter the number of days to limit the import of messages to Chatwoot',
							},
							{
								...
								type: 'string',
								default: '',
								description: 'Enter the Chatwoot QRCode contact name',
							},
							{
								...
								description: 'Enter the URL of the logo for the Chatwoot contact',
							},
						],
					},
				],
						...
						values: [
							{
								...
								type: 'boolean',
								default: false,
								description: 'Whether to send media data in base64 format in the RabbitMQ', // Updated
							},
							{
								displayName: 'Events',
								name: 'rabbitmqEvents',
								type: 'multiOptions',
								default: [], // Added to resolve the error
								options: [
									{
										name: 'CALL',
										value: 'CALL',
				...
				options: [
					{
						...
						values: [
							...
							},
							{
								...
								default: false,
								description:
									'Whether to create a route for each event by appending the event name to the end of the URL', // Updated
							},
							{
								...
								type: 'boolean',
								default: false,
								description: 'Whether to send media data in base64 format in the webhook', // Updated
							},
							{
								displayName: 'Events',
								name: 'webhookEvents',
	...
	// Fields = Delete Instance
	{
		...
		default: '',
		required: true,
		description: 'Enter the name of the instance that will be deleted',
		displayOptions: {
			show: {
				resource: ['instances-api'],
